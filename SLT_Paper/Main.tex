...
Since $F_0$, speaking rate, articulation rate, and pausing shift with model-predicted speaker traits and interaction state, pooled human statistics can be poorly calibrated for evaluating a particular output.
...
Evaluation, however, is still dominated by text-based measures, task success, or subjective ratings, which do not always objectively quantify speech-native interactional behavior. 
