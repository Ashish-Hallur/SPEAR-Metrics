...
% The ORCID number is still optional, but will become mandatory in the future years. It is strongly encouraged to get an ORCID for each co-author.
% Middle names, including initials, must be included in the first name
\author[affiliation={1}, orcid=0009-0006-4979-3701, correspondingauthor]{Ashish G}{Hallur}
\author[affiliation={1}, orcid=0000-0001-8953-7872]{Thomas}{Thebaud}
\author[affiliation={2}, orcid=0009-0001-7214-2919]{Venkatesh}{Ravichandran}
\author[affiliation={3}, orcid=0000-0002-9910-6598]{Georgi}{Tinchev}
\author[affiliation={1}, orcid=0000-0002-3033-7005]{Laureano}{Moro-Velazquez}
% The maximum number of authors in the author list is 20. If the number of contributing authors exceeds this, they should be listed in a footnote or the acknowledgement section.
...
%==================================================================================
% Keywords
\keywords{Distributional Baselines, Conversational Speech, Naturalness Evaluation, Metric Regimes}
...
\subsection{Toward evaluation frameworks}\label{sec:toward_frameworks}\vspace{-2mm}
...
\subsection{Limitations}\label{sec:limitations}\vspace{-2mm}
...
% Generative AI tools were used to support manuscript preparation, primarily for editorial assistance (clarifying wording, improving concision, and restructuring text). All technical content, including study design, experimental implementation, data processing, metric definitions, statistical analyses, figures, and interpretation of results, was produced and verified by the authors. The authors reviewed and edited all AI-assisted text and take full responsibility for the final content of the paper.
